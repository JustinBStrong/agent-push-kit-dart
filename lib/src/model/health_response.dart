...
abstract class HealthResponse implements Built<HealthResponse, HealthResponseBuilder> {
  ...
  // enum serviceEnum {  agent-push-kit,  };
...
class HealthResponseServiceEnum extends EnumClass {
  ...
  @BuiltValueEnumConst(wireName: r'agent-push-kit')
  static const HealthResponseServiceEnum agentPushKit = _$healthResponseServiceEnum_agentPushKit;

  static Serializer<HealthResponseServiceEnum> get serializer => _$healthResponseServiceEnumSerializer;

  const HealthResponseServiceEnum._(String name): super(name);

  static BuiltSet<HealthResponseServiceEnum> get values => _$healthResponseServiceEnumValues;
  static HealthResponseServiceEnum valueOf(String name) => _$healthResponseServiceEnumValueOf(name);
}
